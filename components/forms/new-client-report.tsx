...
export default function ReportFormClient() {
  const [activeTab, setActiveTab] = useState<"video" | "screenshot" | "description">("video")
  ...
  return (
      <div className="space-y-6">
        ...
        <Tabs
            value={activeTab}
            onValueChange={(val) => {
              if (val === "video" || val === "screenshot" || val === "description") {
                setActiveTab(val)
              }
            }}
        >
        ...
        <div className="rounded-md bg-secondary/50 p-4 text-sm flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              ...
              False reports harm the community and dilute the effectiveness of the system.
            </p>
          </div>
        </div>
      </div>
