          ...
          <Tabs defaultValue="reports" className="w-full">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="reports">
                Reports ({profileData.report_count})
              </TabsTrigger>
              <TabsTrigger value="evidence">
                Evidence ({profileData.evidence_count})
              </TabsTrigger>
            ...
            <TabsContent value="reports" className="mt-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    This player has been reported {profileData.report_count}{" "}
                    times
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="evidence" className="mt-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {profileData.evidence_count} pieces of evidence have been
                    submitted
                  </CardDescription>
                </CardHeader>
                <CardContent>
